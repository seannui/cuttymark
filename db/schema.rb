...
ActiveRecord::Schema[8.1].define(version: 2026_01_03_163429) do
  ...
  create_table "clips", force: :cascade do |t|
    ...
    t.string "status", default: "defined", null: false
    t.string "title"
  ...
  create_table "transcripts", force: :cascade do |t|
    ...
    t.index ["video_id", "status"], name: "index_transcripts_on_video_id_and_status"
